// ======================================================================
// Lighting_with_PSoC_ACP.v generated from TopDesign.cysch
// 02/19/2017 at 02:18
...
module Scan_ADC_v1_10_0 (
    ...
    defparam cy_psoc4_sarmux_1.input_mode = "100";
	...
	cy_psoc3_pins_v1_10
		#(.id("d4cf5256-37f5-4752-aee6-f791478268f9/77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("d4cf5256-37f5-4752-aee6-f791478268f9/d2cd031e-911c-40bc-bbf8-28db941411f9"),
	...
	cy_clock_v1_0
		#(.id("d4cf5256-37f5-4752-aee6-f791478268f9/b6815a07-3ae4-40f3-8790-63c50500bc89"),
		  .source_clock_id("413DE2EF-D9F2-4233-A808-DFAF137FD877"),
		  .divisor(2),
		  .period("0"),
		  .is_direct(0),
...
// OpAmp_P4_v1_20(Compensation=3, DeepSleepSupport=false, Mode=0, OutputCurrent=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=OpAmp_P4_v1_20, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PIRAmplifierStage1, CY_INSTANCE_SHORT_NAME=PIRAmplifierStage1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=20, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=PIRAmplifierStage1, )
...
// OpAmp_P4_v1_20(Compensation=3, DeepSleepSupport=false, Mode=1, OutputCurrent=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=OpAmp_P4_v1_20, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=RefBuffer, CY_INSTANCE_SHORT_NAME=RefBuffer, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=20, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=RefBuffer, )
...
// PVref_P4_v1_0(RefSource=0, SelOutputVoltage=16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=PVref_P4_v1_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PVref, CY_INSTANCE_SHORT_NAME=PVref, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=PVref, )
...
// PGA_P4_v1_0(DeepSleepOperation=0, Gain=0, OutputBuffer=0, Power=3, Vref_Input=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=PGA_P4_v1_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PIRAmplifierStage2, CY_INSTANCE_SHORT_NAME=PIRAmplifierStage2, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=PIRAmplifierStage2, )
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=65535, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=65535, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=1000, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=1, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=1, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=false, TermVisibility_line_n=false, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Millis_Update_Timer, CY_INSTANCE_SHORT_NAME=Millis_Update_Timer, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=Millis_Update_Timer, )
...
module top ;
	...
	cy_clock_v1_0
		#(.id("acd89e67-e429-40c4-842f-d6242cd52206"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    defparam Potentiometer.comp_name = "Potentiometer_v1_0";
    defparam Potentiometer.port_names = "T1, T2, W";
	...
	cy_psoc3_pins_v1_10
		#(.id("4b1dae19-ea78-4c76-ab32-5787f04cc20d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 TIP120 (
        .connect({
            Net_2104,
            Net_4878,
            Net_4877
    ...
    defparam TIP120.comp_name = "NPN_v1_0";
    defparam TIP120.port_names = "B, C, E";
    defparam TIP120.width = 3;
    ...
    cy_annotation_universal_v1_0 RS (
        .connect({
            Net_4882,
            Net_2104
        })
    );
    defparam RS.comp_name = "Resistor_v1_0";
    defparam RS.port_names = "T1, T2";
    defparam RS.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("6de866c0-451e-4db5-8092-1fef8b01af7a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 R49 (
        .connect({
            Net_1993,
            Net_1994
        })
    );
    defparam R49.comp_name = "Resistor_v1_0";
    defparam R49.port_names = "T1, T2";
    defparam R49.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("7198d722-88d7-453d-9800-28dd1427143e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__MIC_ANALOG_net;
	wire [0:0] tmpFB_0__MIC_ANALOG_net;
	wire [0:0] tmpIO_0__MIC_ANALOG_net;
	wire [0:0] tmpINTERRUPT_0__MIC_ANALOG_net;
	electrical [0:0] tmpSIOVREF__MIC_ANALOG_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		MIC_ANALOG
		 (.oe(tmpOE__MIC_ANALOG_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MIC_ANALOG_net[0:0]}),
		  .analog({Net_4914}),
		  .io({tmpIO_0__MIC_ANALOG_net[0:0]}),
		  .siovref(tmpSIOVREF__MIC_ANALOG_net),
		  .interrupt({tmpINTERRUPT_0__MIC_ANALOG_net[0:0]}),
		  .annotation({Net_1698}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__MIC_ANALOG_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_1 PWM_LED_Strip (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	cy_clock_v1_0
		#(.id("47c0b28b-6b74-4c4b-adc7-0809222eccd4"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("83333333.3333333"),
		  .is_direct(0),
    ...
    OpAmp_P4_v1_20_4 RefBuffer (
        .Vplus(Net_1082),
        .Vout(Vref),
        .Vminus(Net_4016));

    PVref_P4_v1_0_5 PVref (
        .Vout(Net_1082));
    ...
    PGA_P4_v1_0_6 PIRAmplifierStage2 (
        .Vin(Net_1782),
        .Vref(Vref),
        .Vout(PIR));
	...
	cy_clock_v1_0
		#(.id("bbba4f28-814d-4afb-8e3b-a1eee8c650e7"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    TCPWM_P4_v2_10_7 Switch_Off_Timer (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
    ...
    TCPWM_P4_v2_10_8 Millis_Update_Timer (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
